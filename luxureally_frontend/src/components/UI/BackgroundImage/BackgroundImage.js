	...
	return (
			<div id="content">
                <section className="section section-main bg-dark dark">
                    ...
                    <div className="bg-image bg-fixed"><img src="/static/img/photos/hero-burger.jpg" alt="" /></div>
                        ...
                        <div className="row">
                            <div className="col-md-7 push-md-3">
                                ...
                                <button onClick={() => props.openQRScanner()}
                                   className="btn btn-outline-primary btn-lg"><span>On place</span></button>
                                 <button className="btn btn-outline-primary btn-lg" data-target="#form" data-toggle="modal">
                                    <span>Delivery</span>
                                </button>
                            </div>
                        </div>
